/****************************************************************************
** Meta object code from reading C++ file 'combox.h'
**
...
#error "The header file 'combox.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 7, 19), // "currentIndexChanged"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 23), // "currentIndexChangedSlot"
QT_MOC_LITERAL(4, 52, 5) // "index"

    },
    "Combox\0currentIndexChanged\0\0"
...
void Combox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Combox::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Combox::currentIndexChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Combox::currentIndexChanged(int _t1, int _t2)
{
