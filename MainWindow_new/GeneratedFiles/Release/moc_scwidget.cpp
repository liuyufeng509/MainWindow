...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScWidget_t, stringdata) + ofs \
...
const QMetaObject ScWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ScWidget.data,
      qt_meta_data_ScWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ScWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScWidget.stringdata))
